        ...
        <div className='container-modal'>
            ...
            >
                ...
                <section className='cabecalho-cursos-exper'>
                    <h4 className='titulos-cursos-exper fonte-titulo'><input type="text" class="form-editar cadastros-curriculo" id="nome-curso" placeholder="Nome" /></h4>
                    <h6 className='titulos-cursos-exper fonte-corpo'><input type="text" class="form-editar cadastros-curriculo" id="empresa-curso" placeholder="Empresa" /></h6>
                    <article>
                    ...
                    <p className='conteudo-cursos fonte-corpo'><textarea type="textarea" class="form-editar cadastros-curriculo" id="conteudo-curso" placeholder="Descrição" maxLength={250} /></p>
                </section>
                </div>
