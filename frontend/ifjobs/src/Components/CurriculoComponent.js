  ...
  return (
    <section>
        <article className='cabecalho-perfis'>
          ...
          <h2 className='titulo-perfil'>Nome completo</h2>
          <h5 className='curso'>Curso</h5>
          <p className='sociais'>icones</p>
        </article>
        ...
        <h3 className='titulos-perfis'>Experiência Profissional</h3>
        <div className='experiencia-component'><ExperienciasComponent/></div>
        <h3 className='titulos-perfis'>Cursos e Certificados</h3>
